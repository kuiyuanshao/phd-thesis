...
class SICG:
    ...
    def fit(self, file_path=None, provided_data=None):
        ...
        self.p2_dataset = ImputationDataset(df_p2, self.p1_cols, self.p2_cols, self.cond_cols, weights=self.global_weights)
    ...
    def _get_batch(self, data_iter, dataloader):
        try:
    ...
    def _train_loop(self):
        ...
        for k in range(num_models):
            ...
            dl_p1 = self._get_dataloader("p1", is_bootstrap=(mi_approx == 'BOOTSTRAP'))
            iter_p1 = iter(dl_p1)
            dl_p2 = self._get_dataloader("p2", is_bootstrap=(mi_approx == 'BOOTSTRAP'))
            iter_p2 = iter(dl_p2)
            ...
            for step in pbar:
                for _ in range(loss_cfg['discriminator_steps']):
                    batch, iter_p2 = self._get_batch(iter_p2, dl_p2)
                ...
                opt_G.zero_grad()
                batch_p2, iter_p2 = self._get_batch(iter_p2, dl_p2)
