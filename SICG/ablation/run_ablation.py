...
CONFIG_PROFILES = {
    "unpack": {
        "yaml_file": "./result_configs/config_unpack.yaml",
        "output_dir": "Unpack"
    },
    "pack": {
        "yaml_file": "./result_configs/config_pack.yaml",
        "output_dir": "Pack"
    },
    "unpack_info": {
        "yaml_file": "./result_configs/config_unpack_info.yaml",
        "output_dir": "Unpack_info"
    },
    "pack_mml": {
...
def main():
    ...
    for i in range(start_idx, end_idx):
        ...
        sicg_mod = SICG(base_config, data_info_srs)
        sicg_mod.fit(file_path_srs)
        sicg_mod.impute(save_path=save_path)
