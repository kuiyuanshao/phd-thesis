...
CONFIG_PROFILES = {
    "unpack": {
        "yaml_file": "./tuning_configs/base_config_unpack.yaml",
        "output_csv": "./tuning_results/unpack_tuning_results.csv",
        "tuning_grid": {
            "lr": ("log_float", 1e-4, 5e-3),
            "hidden_dim": ("int_exp2", 6, 10),
            "layers": ("int", 1, 4),
            "weight_decay": ("log_float", 1e-6, 1e-3),
            "dropout": ("float", 0, 0.5),
            "batch_size": ("int_step", 100, 500, 100),
            "scale_layer": ("int", 1, 2),
    ...
    "pack": {
        "yaml_file": "./tuning_configs/base_config_pack.yaml",
        "output_csv": "./tuning_results/pack_tuning_results.csv",
        "tuning_grid": {
            "lr": ("log_float", 1e-4, 5e-3),
            "hidden_dim": ("int_exp2", 6, 10),
            "layers": ("int", 1, 4),
