...
def main():
    ...
    if args.task == "srs":
        ...
        tuner.tune(config_path="../../data/best_config_sird_srs.yaml",
        ...
        tuner.tune(config_path="../../data/best_config_sird_bal.yaml",
        ...
        tuner.tune(config_path="../../data/best_config_sird_ney.yaml",
