...
if not os.path.exists("./simulations/SRS/sicg"):
    os.makedirs("./simulations/SRS/sicg")

if not os.path.exists("./simulations/Balance/sicg"):
    os.makedirs("./simulations/Balance/sicg")

if not os.path.exists("./simulations/Neyman/sicg"):
    os.makedirs("./simulations/Neyman/sicg")
...
with open("./data/best_config_gans_srs.yaml", "r") as f:
    config_srs = yaml.safe_load(f)
# with open("./data/best_config_gans_bal.yaml", "r") as f:
#     config_bal = yaml.safe_load(f)
# with open("./data/best_config_gans_ney.yaml", "r") as f:
