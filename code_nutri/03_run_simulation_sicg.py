...
# with open("./data/Config/best_config_gans_rs.yaml", "r") as f:
#     config_rs = yaml.safe_load(f)
#
# with open("./data/Config/best_config_gans_wrs.yaml", "r") as f:
#     config_wrs = yaml.safe_load(f)
#
# with open("./data/Config/best_config_gans_sfs.yaml", "r") as f:
#     config_sfs = yaml.safe_load(f)
#
# with open("./data/Config/best_config_gans_ods_tail.yaml", "r") as f:
#     config_ods_tail = yaml.safe_load(f)
#
# with open("./data/Config/best_config_gans_neyman_ods.yaml", "r") as f:
#     config_neyman_ods = yaml.safe_load(f)
#
# with open("./data/Config/best_config_gans_neyman_inf.yaml", "r") as f:
...
for i in range(1, 2):
    ...
    save_path_srs = f"./simulations/SRS/sicg/{digit}.parquet"
    save_path_rs = f"./simulations/RS/sicg/{digit}.parquet"
    save_path_wrs = f"./simulations/WRS/sicg/{digit}.parquet"
    save_path_sfs = f"./simulations/SFS/sicg/{digit}.parquet"
    save_path_ods = f"./simulations/ODS_TAIL/sicg/{digit}.parquet"
    save_path_nod = f"./simulations/Neyman_ODS/sicg/{digit}.parquet"
    save_path_nif = f"./simulations/Neyman_INF/sicg/{digit}.parquet"
