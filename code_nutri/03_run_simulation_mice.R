...
for (i in 1:10) {
  ...
  if (sampling_design %in% c("simulations/SRS", "All")) {
    if (!file.exists(file.path("simulations/SampleOE", "simulations/SRS", "mice",
                               paste0(digit, ".RData")))){
      ...
      do_mice(samp, "simulations/SRS", digit, best_config_srs)
    }
  }
