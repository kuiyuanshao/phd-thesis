...
class GAIN:
    ...
    def _init_optimizers(self, G, D):
        ...
        opt_G = optim.Adam(G.parameters(), lr=tc['lr'], betas=tuple(tc.get('betas_g', (0.9, 0.999))),
                           weight_decay=tc.get('weight_decay', 0))
        opt_D = optim.Adam(D.parameters(), lr=tc['lr'], betas=tuple(tc.get('betas_d', (0.9, 0.999))),
                           weight_decay=tc.get('weight_decay', 0))
        return opt_G, opt_D