    ...
    def _get_trial_config(self, trial):
        ...
        for param_name, params in self.param_grid.items():
            ...
            if param_type == "cat":
                ...
                chosen_value = int(2 ** trial.suggest_int(param_name, low_exp, high_exp))
            else:
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(self.splits):
            ...
            try:
                with open(os.devnull, 'w') as f, contextlib.redirect_stdout(f), contextlib.redirect_stderr(f):
                    model = TabCSDI(trial_config, self.data_info)
                ...
                print(f"Trial {trial.number} failed at fold {fold_idx} with error: {e}")
